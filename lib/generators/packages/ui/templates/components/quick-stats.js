export const generateQuickStatsComponent = () => `import { StatCard } from "../stat-card/stat-card";
...
export const generateQuickStatsStory = () => `import type { Meta, StoryObj } from '@storybook/react';
