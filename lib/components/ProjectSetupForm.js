...
export function ProjectSetupForm({ initialName, initialDescription, cliFeatures, onSubmit, onCancel, }) {
    const [step, setStep] = useState(initialName && initialDescription && cliFeatures
        ? 'confirm'
    ...
    const renderHeader = () => (_jsxs(Box, { flexDirection: "column", marginBottom: 1, children: [_jsx(Text, { color: "cyan", bold: true, children: "Create AI QuickStart Project" }), _jsx(Text, { color: "gray", children: "Use arrow keys to navigate \u2022 Space to select \u2022 Enter to continue \u2022 Esc to cancel" })] }));
    const renderNameStep = () => (_jsxs(Box, { flexDirection: "column", children: [renderHeader(), _jsxs(Box, { flexDirection: "column", marginBottom: 1, children: [_jsx(Text, { children: "Project Name:" }), _jsx(TextInput, { value: nameInput, onChange: (value) => {
                            ...
                            if (!error) {
                                ...
                                setStep(initialDescription && cliFeatures
                                    ? 'confirm'
                                    : initialDescription
                                        ? 'packageManager'
                                        : 'description');
