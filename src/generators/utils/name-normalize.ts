 ...
 */
export function normalizeServiceName(projectName: string, packageId: string): string {
 ...
 */
export function normalizeVolumeName(projectName: string, volumeName: string): string {
  const normalized = normalizeName(projectName);
