 ...
 */
export function getScriptCommand(packageManager: PackageManager): string {
 ...
 * @returns The command string
 */
export function runRecursiveScript(
  packageManager: PackageManager,
  script: string,
 ...
 * @returns The command string
 */
export function getSetupCommand(packageManager: PackageManager): string {
