...
export function getPackageManagerVersion(packageManager: string): string {
  return PACKAGE_MANAGER_VERSIONS[packageManager as keyof typeof PACKAGE_MANAGER_VERSIONS] || '1.0.0';
}
...
export type VersionKey = 
  | keyof typeof UI_VERSIONS
  | keyof typeof CORE_VERSIONS
  | keyof typeof PYTHON_VERSIONS;
