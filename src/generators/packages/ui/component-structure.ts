import {
  ...
  generateServiceCardStory,
  generateServiceListComponent,
  generateStatCardComponent,
  generateStatCardStory,
  generateStatusPanelComponent,
  generateThemeProvider,
  generateTooltipComponent,
  generateTooltipStory,
} from './templates/components/index.js';
...
export interface ComponentDefinition {
  ...
  story?: {
    generator: (params: ConfigTemplateParams & RouteTemplateParams) => string;
    passParams?: boolean; // Stories might also need params
  };
